...
1. [P1](./Array/p1_basic.cpp) Program showing basic input and output of an array

2. [Problem2](./Array/p2_getmin.cpp) Program to get minimum element in the array

3. [P3](./Array/p3_getmax.cpp) Program to get minimum element in the array

4. [P4](./Array/p4_linearSearch.cpp) Linear Search in 1-D array

5. [P5](./Array/p5_reversearray.cpp) Reverse array :-1)using S.C.-O(n) 2) S.C.-O(1) two pointer approach

6. [P6](./Array/p6_secondmax.cpp) Program to get second Max in an array. ***[GfG link](https://www.geeksforgeeks.org/problems/second-largest3735/1 )***

7. [P7](./Array/p7_fibonacci.cpp)  store fibonaci series :- 0,1,1,2,3,5,8,13.... in an array

8. [P8](./Array/p8_rotatearrayby1.cpp) Rotate array by 1 ***[GfG link](https://www.geeksforgeeks.org/problems/cyclically-rotate-an-array-by-one2614/1?utm_source=geeksforgeeks&utm_medium=article_practice_tab&utm_campaign=article_practice_tab)***

9. [P9](./Array/p9_missingno.cpp) Missing no ***[GfG link](https://www.geeksforgeeks.org/problems/missing-number-in-array1416/1?utm_source=geeksforgeeks&utm_medium=article_practice_tab&utm_campaign=article_practice_tab)***

10. [P10](./Array/p10_smallestposmissingNO.cpp) Smallest Postive Missing no ***[GfG link](https://www.geeksforgeeks.org/problems/smallest-positive-missing-number-1587115621/1?utm_source=geeksforgeeks&utm_medium=ml_article_practice_tab&utm_campaign=article_practice_tab)***

11. [P11](./Array/p11_MoveNegEle2end.cpp) Move all negative elements to end ***[GfG link](https://www.geeksforgeeks.org/problems/move-all-negative-elements-to-end1813/1?utm_source=geeksforgeeks&utm_medium=ml_article_practice_tab&utm_campaign=article_practice_tab)***


12. [P12](./Array/p12_countNoEle2nos.cpp) Count number of elements between two given elements in array ***[GfG link](https://www.geeksforgeeks.org/problems/count-number-of-elements-between-two-given-elements-in-array4044/1?utm_source=geeksforgeeks&utm_medium=ml_article_practice_tab&utm_campaign=article_practice_tab)***
...
11. [QuickSort](./recursion/lec11_quicksort.cpp)
...
- Problem statements:-
  - ReverseLinkedList [Approach1](./LinkedList/lec3_1.cpp) ; [Approach2](./LinkedList/lec3_2.cpp) ;[Recursive](./LinkedList/lec3_3.cpp):- ***[leetcode](https://leetcode.com/problems/reverse-linked-list/description/)*** 
  - Middle of LinkedList [Approach1](./LinkedList/lec3_4.cpp) ; [Approach2](./LinkedList/lec3_5.cpp) :- ***[leetcode](https://leetcode.com/problems/middle-of-the-linked-list/)*** 
  - [RemoveNthNodeFromEnd](./LinkedList/lec3_6.cpp) :- ***[leetcode](https://leetcode.com/problems/remove-nth-node-from-end-of-list/)*** 
   - [RemoveEveryKthNode](./LinkedList/lec3_7.cpp) :- ***[gfg](https://www.geeksforgeeks.org/problems/remove-every-kth-node/1?utm_source=geeksforgeeks&utm_medium=article_practice_tab&utm_campaign=article_practice_tab)*** 
...
## Binary Tree
  ...
  - View Questions
    - [Left View of Binary Tree](./BinaryTree/lec7_18.cpp) ; [Approach2](./BinaryTree/lec7_18_2.cpp):- ***[gfg](https://www.geeksforgeeks.org/problems/left-view-of-binary-tree/1?page=1&difficulty%5B%5D=0&category%5B%5D=Tree&sortBy=submissions)***
...
## Graph 
  - Basics 
    - [Adjacency Matrix](./Graph/lec8_1.cpp)
    - [Adjacency List](./Graph/lec8_2.cpp)
  - Graph Traversal
     - [BFS](./Graph/lec8_3.cpp):- ***[gfg](https://www.geeksforgeeks.org/problems/bfs-traversal-of-graph/1?page=1&difficulty%5B%5D=0&category%5B%5D=Graph&sortBy=submissions)***
     - [DFS: recursive](./Graph/lec8_4.cpp):- ***[gfg](https://www.geeksforgeeks.org/problems/depth-first-traversal-for-a-graph/1?page=1&difficulty%5B%5D=0&category%5B%5D=Graph&sortBy=submissions)***
     - [DFS: iterative](./Graph/lec8_5.cpp):- ***[gfg](https://www.geeksforgeeks.org/problems/depth-first-traversal-for-a-graph/1?page=1&difficulty%5B%5D=0&category%5B%5D=Graph&sortBy=submissions)***
